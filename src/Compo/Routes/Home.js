  ...
  return (
    <>
      ...
      <div className='maincontent'>
        <h1 className='headingtext'>The India Tourism - Guided &amp; Customized Private Tour to India</h1>
        <p>
        ...
        <h2 className='headingtext'>Find your Perfect Holiday Destination</h2>
        <p>
        ...
        <div>
          <h2 className='headingtext'>Choose Your Style of Tour Packages</h2>
